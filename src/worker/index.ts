...
function accountingBillingSettingsPage(
  ...
  const connectionAction = status.configured
    ...
    : "";
  const backAction = `<a class="billing-settings-back" href="/learn/admin/accounting" aria-label="Back to accounting" title="Back to accounting"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2Z"></path></svg></a>`;
