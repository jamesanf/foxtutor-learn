...
function navigation(role: Role): string {
  const icons = {
    ...
    accounting: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm-2 3h5v2h-2.5c.67.62 1 1.35 1 2.18 0 .34-.05.68-.15 1.02H15v2h-2.62c-.22.7-.63 1.28-1.23 1.74-.34.26-.72.47-1.15.64H15v2H8v-2h1.05c1.02-.42 1.55-1.05 1.6-1.98H8.5v-2h2.04c.1-.3.15-.61.15-.93 0-.81-.41-1.7-1.24-2.67H10V5Z",
