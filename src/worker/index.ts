...
function navigation(role: Role): string {
  const icons = {
    ...
    accounting: "M12 2C7.58 2 4 3.79 4 6v4c0 2.21 3.58 4 8 4s8-1.79 8-4V6c0-2.21-3.58-4-8-4Zm0 2c3.31 0 6 0.9 6 2s-2.69 2-6 2-6-.9-6-2 2.69-2 6-2Zm-8 6c0 2.21 3.58 4 8 4s8-1.79 8-4v4c0 2.21-3.58 4-8 4s-8-1.79-8-4v-4Zm0 4c0 2.21 3.58 4 8 4s8-1.79 8-4v4c0 2.21-3.58 4-8 4s-8-1.79-8-4v-4Z",
