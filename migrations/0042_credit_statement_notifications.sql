-- Add credit-covered billing statements to the durable notification outbox.
PRAGMA foreign_keys = OFF;

ALTER TABLE notifications RENAME TO notifications_phase717_credit_statement;
...
CREATE TABLE notifications (
  ...
  event_type TEXT NOT NULL CHECK (event_type IN (
    ...
    'BILLING_CREDIT_COVERED_STATEMENT'
  )),
...
SELECT * FROM notifications_phase717_credit_statement;

DROP TABLE notifications_phase717_credit_statement;
...
ALTER TABLE notification_settings RENAME TO notification_settings_phase717_credit_statement;
...
SELECT * FROM notification_settings_phase717_credit_statement;

INSERT INTO notification_settings
  (event_type, enabled, timing_minutes, subject_prefix, body_note, updated_at)
VALUES
  ('BILLING_CREDIT_COVERED_STATEMENT', 1, NULL, '', '', CURRENT_TIMESTAMP)
ON CONFLICT(event_type) DO NOTHING;

DROP TABLE notification_settings_phase717_credit_statement;
