...
The final application tree at `4c6ee44` passed:
...
application release `4c6ee44` is deployed as Worker
`ade5f1aa-85cf-4bad-91d0-3a30abdb1881`. Production deployment and
